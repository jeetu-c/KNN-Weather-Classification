...
st.set_page_config(page_title="OWN Weather Classification", layout="wide")
st.title(" K-Nearest Neighbor Weather Classification")

X = np.array([[25, 80], [27, 60], [31, 65], [23, 85], [20, 75], [30, 70]])
y = np.array([1, 0, 0, 1, 1, 0])
labels = {0: "Sunny", 1: "Rainy"}

st.sidebar.header("Input Parameters")
temp = st.sidebar.slider("Temperature (°C)", 18, 60, 26)
hum = st.sidebar.slider("Humidity (%)", 58, 95, 78)
